        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-soft-charcoal space-y-10">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                La réservation s&apos;effectue en ligne sur le site (page Réservation) ou par téléphone / WhatsApp au{" "}
                {CONTACT_PHONE_DISPLAY}. La durée minimum de réservation est d&apos;une heure. Au-delà, les réservations se
                font par tranches de 30 minutes. Les réservations à la demi-journée ou à la journée sont soumises à devis sur
                demande.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-display font-semibold text-charcoal mb-3">
                7. Activités dans les studios
              </h2>
              <p className="leading-relaxed">
                RJ Studio met des espaces à disposition à la location horaire. Il n&apos;organise pas de cours collectifs
                fixes ni d&apos;emploi d&apos;instructeurs salariés : les professeurs, coachs et artistes qui louent un
                studio organisent leurs propres séances et restent responsables de leurs participants.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                {CONTACT_EMAIL} ou au {CONTACT_PHONE_DISPLAY}. Le droit marocain est applicable.
              </p>
            </section>
          </div>
